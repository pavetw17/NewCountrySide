 ...
 *  - <OpenLayers.Layer>
 */
OpenLayers.Layer.VectorEx = OpenLayers.Class(OpenLayers.Layer, {
    ...
    assignRenderer: function()  {
        ...
        for (var i=0, len=this.renderers.length; i<len; i++) {
           ...
           // alert(renderer);
           // alert(renderer.prototype.supported());
     ...
     * options - {Object}
     */
    addFeatures: function(features,drawNow, options) {
    ...
    removeFeatures: function(features, options) {
        ...
        for (var i = features.length - 1; i >= 0; i--) {
            ...
            if (feature.geometry) {
            	//cwrs_debug('remove feature :'+feature.fid,false);
    ...
    CLASS_NAME: "OpenLayers.Layer.VectorEx"
});
