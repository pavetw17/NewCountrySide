...
var ddaccordion={
	ajaxloadingmsg: '<img src="'+ newURL +'resources/images/loading2.gif" /><br />Loading Content...', //customize HTML to output while Ajax content is being fetched (if applicable)
