		...
		if (searchText1 != null) {
			if (searchText1.value != null && searchText1.value != "" && searchText1.value != "Từ khóa tìm kiếm") {
				window.location.href = "<%=request.getContextPath()%>/ChuyenTrang?tukhoa="
						+ searchText1.value.replace("'","''") + "&action=113&page=1";
			} else {
...
<div class="box-c">
    ...
    <span style="color:#B5250A; text-decoration: underline; font-style: inherit; font-weight: bold;">${row_tenthumuc[0].ten_phannhom_detai}</span>
</div>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr class="tblHeader_vanban">
						<td width="25%" valign="middle" height="30" nowrap="nowrap"
							align="center" class="headerText">Tên đề tài</td>
						<td width="16%" valign="middle" height="30" nowrap="nowrap"
							align="center" class="headerText">Lĩnh vực</td>
						<td width="16%" valign="middle" height="30" nowrap="nowrap"
							align="center" class="headerText">Thời gian</td>
						<td width="43%" valign="middle" height="30" nowrap="nowrap"
							align="center" class="headerText">Kinh phí</td>
					</tr>
					...
					<c:forEach var="list" items="${list}" varStatus="loopStatus">
						<tr class="${loopStatus.index % 2 == 0 ? 'item_even' : 'item_odd'}">
							<td width="50%" valign="middle" align="justify" class="vbText">
								<a href="ChuyenTrang?action=112&so_id=${list.id_detai}"><div class="noidung_vanban_tt"><p>​
								${list.tendt} </p></div></a> </td>
