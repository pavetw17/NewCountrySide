<?php
        ...
        $mcImageManagerConfig['general.language'] = "vi"; // en, sv
        ...
        // Preview options
        $mcImageManagerConfig['preview.wwwroot'] = 'C:/Program Files (x86)/Apache Software Foundation/Tomcat 7.0/webapps/NTK2015/uploads/'; // absolute or relative from this script path, try to leave blank system figures it out.
        $mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/NTK2015/uploads/"; // domain name
        ...
        $mcImageManagerConfig['filesystem.rootpath'] = 'C:Program Files (x86)/Apache Software Foundation/Tomcat 7.0/webapps/NTK2015/uploads/'; // absolute or relative from this script path, required.
