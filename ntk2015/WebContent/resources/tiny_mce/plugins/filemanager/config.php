<?php
        ...
        // Preview options
        $mcFileManagerConfig['preview.wwwroot'] = 'C:/Program Files (x86)/Apache Software Foundation/Tomcat 7.0/webapps/NTK2015/uploads/'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
        $mcFileManagerConfig['preview.urlprefix'] = "{proto}://{host}/NTK2015/uploads/"; // domain name
        ...
        $mcFileManagerConfig['filesystem.path'] = 'C:/Program Files (x86)/Apache Software Foundation/Tomcat 7.0/webapps/NTK2015/uploads/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = 'C:/Program Files (x86)/Apache Software Foundation/Tomcat 7.0/webapps/NTK2015/uploads/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,pdf,doc,docx";
