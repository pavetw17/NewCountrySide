 ...
 *  - <OpenLayers.Handler> 
 */
OpenLayers.Handler.BoxEx = OpenLayers.Class(OpenLayers.Handler, {
    ...
    */
    endBox: function(end) {
        var result;
        if (Math.abs(this.dragHandler.start.x - end.x) > 0 ||    
            Math.abs(this.dragHandler.start.y - end.y) > 0) {   
    ...
    CLASS_NAME: "OpenLayers.Handler.BoxEx"
});
