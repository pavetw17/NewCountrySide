...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,weeks:["CN","T2","T3","T4","T5","T6","T7"],months:["Tháng 1","Tháng 2","Tháng 3","Tháng 4","Tháng 5","Tháng 6","Tháng 7","Tháng 8","Tháng 9","Tháng 10","Tháng 11","Tháng 12"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(_3b){
}};
})(jQuery);
/**
 * jQuery EasyUI 1.2.4
...
_a(this,q);
}},currentText:"Hôm nay",closeText:"Đóng",okText:"Ok",formatter:function(_1b){
