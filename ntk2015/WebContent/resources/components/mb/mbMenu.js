    ...
    buildMbMenu: function(op,m,type,e){
      ...
      if ($.metadata){
        ...
        $(this.voices).each(function(){
          ...
          if ($(this).metadata().img){ 
        	  $(this).attr("img",$(this).metadata().img);
          }
          if ($(this).metadata().menu) $(this).attr("menu",$(this).metadata().menu);
          if ($(this).metadata().action) $(this).attr("action",$(this).metadata().action);
          
          if ($(this).metadata().imgClass) $(this).attr("imgClass",$(this).metadata().imgClass);
        });
      }
      ...
      $(this.voices).each(function(i){
        ...
        if (op.options.hasImages && !isText && !isBoxmenu){
        	 ...
        	 if($(voice).attr("imgClass") != undefined){
           	 // imgPath=(imgPath.length>3 && imgPath.indexOf(".")>-1)?("<img class='"+ $(voice).attr("imgClass") +"'>"):imgPath;
           	  imgPath = "<img class='"+ $(voice).attr("imgClass") + "'>";
        ...
        if(!isSeparator){
          ...
          if(isDisabled){
            menuLine.addClass("disabled").css({cursor:"pointer"});
          }
            ...
            menuLine.mb_hover(
                    ...
                    function(event){
                      ...
                      if ($(voice).attr("menu")){
                        ...
                        if (!$(voice).attr("action")) $(opener.menuContainer).find("#"+m+"_"+i).css("cursor","pointer");
                        if (!opener.menuContainer.actualSubmenu || opener.menuContainer.actualSubmenu!=this){
                          $(opener.menu).find(".menuDiv").remove();
